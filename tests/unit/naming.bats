...
# There was a second such string until 2026-08-30 - the vendored copy inside the
# Investio repository - but that directory has since been renamed to `ib-docker`
# too, read from the running containers' compose labels.
#
...
@test "naming: nothing points at this repository by its old name" {
	...
	# `gnzsnz/ib-gateway-docker`; neither resolves to anything here, so matching
	# them would only train people to ignore this.
	#
